...
echo '/usr/local/bin/dvtws --port 989 --filter-tcp=443 --dpi-desync=multidisorder --hostlist="/home/definitly/files/list-youtube.txt" --dpi-desync-split-pos=1,midsld  --dpi-desync-repeats=11 --dpi-desync-ttl=0 --dpi-desync-any-protocol --dpi-desync-cutoff=d4 --dpi-desync-fooling=badseq &' >> /etc/rc.firewall.my
