...
import getpass
import subprocess
start_docker = "doas service torbox onestart"
stop_docker =  "doas service torbox onestop"
...
class AnotherWindow(Gtk.Window):
    def __init__(self):
        ...
        self.add(label)
        self.show_all()
        sub_proc =  subprocess.check_output(['doas','service','torbox','status'], universal_newlines=True)
        sub_outp = ""
...
class bl_exit:
    ...
    def create_window(self):
        ...
        #start vpn  button
        self.suspend = Gtk.Button("Start TorBox")
        ...
        #stop vpn  button
        self.reboot = Gtk.Button("Stop TorBox")
        ...
        #stop vpn  button
        self.status = Gtk.Button("Status TorBox")
