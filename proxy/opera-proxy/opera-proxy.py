...
import getpass
import subprocess
start_docker = "/usr/local/bin/opera-proxy &"
stop_docker =  "killall -9 opera-proxy "
...
class AnotherWindow(Gtk.Window):
    def __init__(self):
        ...
        self.add(label)
        self.show_all()
        sub_proc =  subprocess.check_output(['pgrep','opera-proxy'], universal_newlines=True)
        sub_outp = ""
...
class bl_exit:
    ...
    def create_window(self):
        ...
        #start vpn  button
        self.suspend = Gtk.Button("Start Opera Proxy")
        ...
        #stop vpn  button
        self.reboot = Gtk.Button("Stop Opera Proxy")
        ...
        #stop vpn  button
        self.status = Gtk.Button("Status Opera Proxy")
